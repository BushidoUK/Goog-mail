...
try:
    while page_counter < 50 :
        results = 'http://groups.google.com/groups?q=' + str(domain_name)+'&hl=e$
        request = urllib2.Request(results)
        request.add_header('User-Agent','Mozilla/4.0 (compatible; MSIE 5.5; Wind$
...
try:
    ...
    while page_counter_web < 50 :
        results_web = 'http://www.google.com/search?q=%40'+str(domain_name)+'&hl$
        request_web = urllib2.Request(results_web)
        request_web.add_header('User-Agent','Mozilla/4.0 (compatible; MSIE 5.5; $
